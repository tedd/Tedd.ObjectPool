...
#endif
namespace Tedd.ObjectPool.Benchmarks.Legacy;
...
/// </summary>
public class ObjectPool1<T> where T : class
{
...
#else
                return "Leak tracing information is disabled. Define TRACE_LEAKS on ObjectPool1`1.cs to get more info \n";
#endif
            }
    ...
    public ObjectPool1(Factory factory)
        : this(factory, Environment.ProcessorCount * 2)
    { }

    public ObjectPool1(Factory factory, int size)
    {
        Debug.Assert(size >= 1);
        _factory = factory;
        _items = new Element[size - 1];
    }
    public ObjectPool1(Factory factory, Action<T> cleanup, int size)
    {
        Debug.Assert(size >= 1);
        _factory = factory;
        _cleanup = cleanup;
